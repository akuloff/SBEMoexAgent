...
@javax.annotation.Generated(value = {"sbe.OrderCancelRequestDecoder"})
...
public class OrderCancelRequestDecoder
{
    ...
    public String account()
    {
        ...
        buffer.getBytes(this.offset + 16, dst, 0, 7);
