...
@javax.annotation.Generated(value = {"sbe.EmptyBookDecoder"})
@SuppressWarnings("all")
public class EmptyBookDecoder
{
    ...
    private final EmptyBookDecoder parentMessage = this;
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[EmptyBook](sbeTemplateId=");
