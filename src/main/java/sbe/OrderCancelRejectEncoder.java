...
@javax.annotation.Generated(value = {"sbe.OrderCancelRejectEncoder"})
...
public class OrderCancelRejectEncoder
{
    ...
    public OrderCancelRejectEncoder clOrdID(final long value)
    {
    ...
    public OrderCancelRejectEncoder timestamp(final long value)
    {
    ...
    public OrderCancelRejectEncoder ordRejReason(final int value)
    {
    ...
    {
        OrderCancelRejectDecoder writer = new OrderCancelRejectDecoder();
