...
@javax.annotation.Generated(value = {"sbe.NewOrderMultilegResponseDecoder"})
@SuppressWarnings("all")
public class NewOrderMultilegResponseDecoder
{
    ...
    private final NewOrderMultilegResponseDecoder parentMessage = this;
    ...
    public NewOrderMultilegResponseDecoder wrap(
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[NewOrderMultilegResponse](sbeTemplateId=");
