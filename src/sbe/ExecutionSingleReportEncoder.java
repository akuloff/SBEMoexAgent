...
@javax.annotation.Generated(value = {"sbe.ExecutionSingleReportEncoder"})
@SuppressWarnings("all")
public class ExecutionSingleReportEncoder
{
    ...
    private final ExecutionSingleReportEncoder parentMessage = this;
    ...
    public ExecutionSingleReportEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public ExecutionSingleReportEncoder clOrdID(final long value)
    {
    ...
    public ExecutionSingleReportEncoder timestamp(final long value)
    {
    ...
    public ExecutionSingleReportEncoder orderID(final long value)
    {
    ...
    public ExecutionSingleReportEncoder trdMatchID(final long value)
    {
    ...
    public ExecutionSingleReportEncoder lastQty(final long value)
    {
    ...
    public ExecutionSingleReportEncoder orderQty(final long value)
    {
    ...
    public ExecutionSingleReportEncoder tradingSessionID(final int value)
    {
    ...
    public ExecutionSingleReportEncoder clOrdLinkID(final int value)
    {
    ...
    public ExecutionSingleReportEncoder securityID(final int value)
    {
    ...
    public ExecutionSingleReportEncoder side(final SideEnum value)
    {
    ...
    {
        ExecutionSingleReportDecoder writer = new ExecutionSingleReportDecoder();
