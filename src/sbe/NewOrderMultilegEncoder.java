...
@javax.annotation.Generated(value = {"sbe.NewOrderMultilegEncoder"})
@SuppressWarnings("all")
public class NewOrderMultilegEncoder
{
    public static final int BLOCK_LENGTH = 45;
    public static final int TEMPLATE_ID = 6001;
    public static final int SCHEMA_ID = 19781;
    public static final int SCHEMA_VERSION = 1;

    private final NewOrderMultilegEncoder parentMessage = this;
    ...
    public NewOrderMultilegEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public NewOrderMultilegEncoder clOrdID(final long value)
    {
    ...
    public NewOrderMultilegEncoder expireDate(final long value)
    {
    ...
    public NewOrderMultilegEncoder securityID(final int value)
    {
    ...
    public NewOrderMultilegEncoder clOrdLinkID(final int value)
    {
    ...
    public NewOrderMultilegEncoder orderQty(final long value)
    {
    ...
    public NewOrderMultilegEncoder timeInForce(final TimeInForceEnum value)
    {
    ...
    public NewOrderMultilegEncoder side(final SideEnum value)
    {
    ...
    public void account(final int index, final byte value)
    {
        ...
        final int pos = this.offset + 38 + (index * 1);
    ...
    public NewOrderMultilegEncoder putAccount(final byte[] src, final int srcOffset)
    {
        final int length = 7;
        ...
        buffer.putBytes(this.offset + 38, src, srcOffset, length);

        return this;
    }

    public NewOrderMultilegEncoder account(final String src)
    {
        final int length = 7;
        ...
        buffer.putBytes(this.offset + 38, bytes, 0, bytes.length);

        for (int start = bytes.length; start < length; ++start)
        {
            buffer.putByte(this.offset + 38 + start, (byte)0);
        }
    ...
    {
        NewOrderMultilegDecoder writer = new NewOrderMultilegDecoder();
