...
@javax.annotation.Generated(value = {"sbe.OrderReplaceRejectDecoder"})
@SuppressWarnings("all")
public class OrderReplaceRejectDecoder
{
    public static final int BLOCK_LENGTH = 20;
    public static final int TEMPLATE_ID = 7006;
    public static final int SCHEMA_ID = 19781;
    public static final int SCHEMA_VERSION = 1;

    private final OrderReplaceRejectDecoder parentMessage = this;
    ...
    public OrderReplaceRejectDecoder wrap(
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[OrderReplaceReject](sbeTemplateId=");
