...
@javax.annotation.Generated(value = {"sbe.OrderMassCancelResponseDecoder"})
@SuppressWarnings("all")
public class OrderMassCancelResponseDecoder
{
    ...
    private final OrderMassCancelResponseDecoder parentMessage = this;
    ...
    public OrderMassCancelResponseDecoder wrap(
    ...
    public static int ordRejReasonId()
    {
        return 103;
    }

    public static int ordRejReasonSinceVersion()
    {
        return 0;
    }
    ...
    public static String ordRejReasonMetaAttribute(final MetaAttribute metaAttribute)
    {
        switch (metaAttribute)
        {
            case EPOCH: return "unix";
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[OrderMassCancelResponse](sbeTemplateId=");
        ...
        builder.append(timestamp());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='TotalAffectedOrders', referencedName='null', description='null', id=533, version=0, deprecated=0, encodedLength=0, offset=16, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
        ...
        builder.append(totalAffectedOrders());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='OrdRejReason', referencedName='null', description='null', id=103, version=0, deprecated=0, encodedLength=0, offset=20, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
        //Token{signal=ENCODING, name='Int32', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=4, offset=20, componentTokenCount=1, encoding=Encoding{presence=OPTIONAL, primitiveType=INT32, byteOrder=LITTLE_ENDIAN, minValue=-2147483648, maxValue=2147483646, nullValue=2147483647, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
