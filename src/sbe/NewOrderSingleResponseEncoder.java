...
@javax.annotation.Generated(value = {"sbe.NewOrderSingleResponseEncoder"})
@SuppressWarnings("all")
public class NewOrderSingleResponseEncoder
{
    ...
    private final NewOrderSingleResponseEncoder parentMessage = this;
    ...
    public NewOrderSingleResponseEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public NewOrderSingleResponseEncoder clOrdID(final long value)
    {
    ...
    public NewOrderSingleResponseEncoder timestamp(final long value)
    {
    ...
    public NewOrderSingleResponseEncoder expireDate(final long value)
    {
    ...
    public NewOrderSingleResponseEncoder orderID(final long value)
    {
    ...
    public NewOrderSingleResponseEncoder securityID(final int value)
    {
    ...
    public NewOrderSingleResponseEncoder orderQty(final long value)
    {
    ...
    public NewOrderSingleResponseEncoder tradingSessionID(final int value)
    {
    ...
    public NewOrderSingleResponseEncoder clOrdLinkID(final int value)
    {
    ...
    public NewOrderSingleResponseEncoder side(final SideEnum value)
    {
    ...
    {
        NewOrderSingleResponseDecoder writer = new NewOrderSingleResponseDecoder();
