...
@javax.annotation.Generated(value = {"sbe.NewOrderMultilegDecoder"})
@SuppressWarnings("all")
public class NewOrderMultilegDecoder
{
    ...
    private final NewOrderMultilegDecoder parentMessage = this;
    ...
    public NewOrderMultilegDecoder wrap(
    ...
    public int getAccount(final byte[] dst, final int dstOffset)
    {
        ...
        buffer.getBytes(this.offset + 38, dst, dstOffset, length);
    ...
    public String account()
    {
        ...
        buffer.getBytes(this.offset + 38, dst, 0, 7);
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        limit(offset + actingBlockLength);
        builder.append("[NewOrderMultileg](sbeTemplateId=");
        ...
        builder.append(side());
        builder.append('|');
        //Token{signal=BEGIN_FIELD, name='Account', referencedName='null', description='null', id=1, version=0, deprecated=0, encodedLength=0, offset=38, componentTokenCount=3, encoding=Encoding{presence=REQUIRED, primitiveType=null, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='null', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
        //Token{signal=ENCODING, name='String7', referencedName='null', description='null', id=-1, version=0, deprecated=0, encodedLength=7, offset=38, componentTokenCount=1, encoding=Encoding{presence=REQUIRED, primitiveType=CHAR, byteOrder=LITTLE_ENDIAN, minValue=null, maxValue=null, nullValue=null, constValue=null, characterEncoding='UTF-8', epoch='unix', timeUnit=nanosecond, semanticType='null'}}
